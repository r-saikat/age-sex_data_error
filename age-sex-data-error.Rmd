...
The __Whipple's index__ measures the extent of preference for ages ending with 0 and 5 under the assumption of rectangularity or linearity assumption in a ten-year age range.
...
The *Whipple's index* for both ages ending 0 and 5 are very high. This denotes that the data is not accurate due to high digit preferences for 0 and 5 which results in age-heaping.
